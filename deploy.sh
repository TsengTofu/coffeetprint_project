...
# git push -f git@github.com:TsengTofu/coffeetprint_project.git master:gh-pages
# 除此之外，也可以改走 HTTPS 模式
git push -f https://github.com/TsengTofu/coffeetprint_project.git master:gh-pages
